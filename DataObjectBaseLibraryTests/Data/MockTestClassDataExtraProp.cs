namespace DataObjectBaseLibraryTests.Data
{
    ...
    class MockTestClassDataExtraProp : IResultRow
    {
        ...
        private readonly char? nCharVal = null;
        ...
        private readonly int? someNonExistingProperty = 1;


        private readonly object[] cells;
        private readonly ColumnInfo[] columnInfos;

        public MockTestClassDataExtraProp()
        {
